...
function ResponsiveDrawer(props) {
  ...
  const drawer = (
    <div className="draws-box">
      <Toolbar className="draws-box" />
      <h1 className="side-bar-title">Home</h1>
      <Divider />

      <List>
        <h3 className="side-bar-sub-heading">Nutrition</h3>
        {nutarr.map((text, index) => (
          <ListItem key={text} disablePadding>
            <ListItemButton>
              <Link to={text.name} spy={true} smooth={true} offset={-160}>
                <ListItemText>
                  <span className="side-bar-li">{text.name}</span>
                </ListItemText>
              </Link>
            </ListItemButton>
          </ListItem>
      ...
      <Divider />
      <List>
        <h3 className="side-bar-sub-heading">Vitamins And Minerals</h3>
        {VitArray.map((text, index) => (
          <ListItem key={text} disablePadding>
            <ListItemButton>
              <Link to={text.name} spy={true} smooth={true} offset={-160}>
                <ListItemText>
      ...
      <Divider />
      <List>
        <h3 className="side-bar-sub-heading">Training & Traits</h3>
        {TrainingSummaryArray.map((text, index) => (
          <ListItem key={text} disablePadding>
            <ListItemButton>
              <Link to={text.name} spy={true} smooth={true} offset={-160}>
                <ListItemText>
      ...
      <Divider />
      <List>
        <h3 className="side-bar-sub-heading">Injury Risk</h3>
        {injarr.map((text, index) => (
          <ListItem key={text} disablePadding>
            <ListItemButton>
              <Link to={text.name} spy={true} smooth={true} offset={-160}>
                <ListItemText>
