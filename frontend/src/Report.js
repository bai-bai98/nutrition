...
import DonutChartT from "./TrainingPredispositions";
...
const Report = () => {
  const reportInformation = [
    {
      description:
        "Lorem ipsum dolor sit amet. Ut exercitationem fugiat hic eligendi nobis non nisi eius id provident quaerat rem quia repudiandae. Eos vitae sunt ut corrupti dolores qui fuga sint totam omnis non internos explicabo sit sint corporis in aperiam explicabo. Vel consectetur cumque qui tenetur sint hic optio doloremque quo numquam nihil aut molestiae fuga sed facilis ratione nam nihil vitae. Quo quibusdam tempora ut enim facere est debitis minima ab perferendis ratione. Eum quas rerum qui omnis rerum hic enim corporis sed quas velit est nihil incidunt hic assumenda fuga. Non quisquam obcaecati est dolores numquam ab autem voluptates sed optio consequatur. Id quia voluptatibus eum quasi dicta ut odio animi. Aut enim dicta aut inventore quaerat et internos explicabo eum voluptatem deserunt.",
      meaning:
        "Lorem ipsum dolor sit amet. Ut exercitationem fugiat hic eligendi nobis non nisi eius id provident quaerat rem quia repudiandae. Eos vitae sunt ut corrupti dolores qui fuga sint totam omnis non internos explicabo sit sint corporis in aperiam explicabo. Vel consectetur cumque qui tenetur sint hic optio doloremque quo numquam nihil aut molestiae fuga sed facilis ratione nam nihil vitae. Quo quibusdam tempora ut enim facere est debitis minima ab perferendis ratione. Eum quas rerum qui omnis rerum hic enim corporis sed quas velit est nihil incidunt hic assumenda fuga. Non quisquam obcaecati est dolores numquam ab autem voluptates sed optio consequatur. Id quia voluptatibus eum quasi dicta ut odio animi. Aut enim dicta aut inventore quaerat et internos explicabo eum voluptatem deserunt.",
  ...
  const indexa = reportInformation.findIndex((object) => {
    return object.name === "Fat Sensitivity";
  });

  nutarr.push(reportInformation[indexa]);
  testarr.push(reportInformation[indexa]);

  const indexb = reportInformation.findIndex((object) => {
    return object.name === "Carbohydrate Sensitivity";
  });

  nutarr.push(reportInformation[indexb]);
  testarr.push(reportInformation[indexb]);
  const indexc = reportInformation.findIndex((object) => {
    return object.name === "Salt Sensitivity";
  });

  nutarr.push(reportInformation[indexc]);
  const indexd = reportInformation.findIndex((object) => {
    return object.name === "Caffeine Sensitivity";
  });

  nutarr.push(reportInformation[indexd]);
  const indexe = reportInformation.findIndex((object) => {
    return object.name === "Lactose Tolerance";
  });

  nutarr.push(reportInformation[indexe]);
  const indexf = reportInformation.findIndex((object) => {
    return object.name === "Antioxidant Requirement";
  });

  nutarr.push(reportInformation[indexf]);

  const index1 = reportInformation.findIndex((object) => {
    return object.name === "Power Response";
  });

  trainingarr.push(reportInformation[index1]);

  const index2 = reportInformation.findIndex((object) => {
    return object.name === "Endurance Response";
  });

  trainingarr.push(reportInformation[index2]);
  const index3 = reportInformation.findIndex((object) => {
    return object.name === "Strength Response";
  });

  trainingarr.push(reportInformation[index3]);
  const index4 = reportInformation.findIndex((object) => {
    return object.name === "Aerobic (V02) Trainability";
  });

  trainingarr.push(reportInformation[index4]);
  const index5 = reportInformation.findIndex((object) => {
    return object.name === "Recovery Efficiency";
  });

  trainingarr.push(reportInformation[index5]);
  const index6 = reportInformation.findIndex((object) => {
    return object.name === "Muscle Mass Predisposition";
  });

  trainingarr.push(reportInformation[index6]);
  const index7 = reportInformation.findIndex((object) => {
    return object.name === "Motivation To Exercise";
  });

  trainingarr.push(reportInformation[index7]);
  const index8 = reportInformation.findIndex((object) => {
    return object.name === "Exercise Tolerance";
  });

  trainingarr.push(reportInformation[index8]);
  const index9 = reportInformation.findIndex((object) => {
    return object.name === "Injury Predisposition";
  });

  trainingarr.push(reportInformation[index9]);
  injarr.push(reportInformation[index9]);
  const index10 = reportInformation.findIndex((object) => {
    return object.name === "Achilles Injury Risk";
  });

  trainingarr.push(reportInformation[index10]);
  injarr.push(reportInformation[index10]);
  const index11 = reportInformation.findIndex((object) => {
    return object.name === "ACL Injury Risk";
  });

  trainingarr.push(reportInformation[index11]);
  injarr.push(reportInformation[index11]);
  const index12 = reportInformation.findIndex((object) => {
    return object.name === "Lower Back Injury Risk";
  });

  trainingarr.push(reportInformation[index12]);
  injarr.push(reportInformation[index12]);
  const index13 = reportInformation.findIndex((object) => {
    return object.name === "Aerobic (VO2) Trainability & recovery";
  });

  trainingarr.push(reportInformation[index13]);
  injarr.push(reportInformation[index13]);
  let NutritionArray = reportInformation.filter(
    (item) => !trainingarr.includes(item)
  );
  let TrainingArray = reportInformation.filter(
    (item) => !NutritionArray.includes(item)
  );
  let TrainingSummaryArray = TrainingArray.filter(
    (item) => !injarr.includes(item)
  );
  ...
  let VitArray = NutritionArray.filter((item) => !nutarr.includes(item));

  const headers = ["Gene", "Overview", "RS ID", "Genotype"];

  return (
    <div className="reportpagediv">
      <ResponsiveDrawer className="respons" />
      <div className="report-container">
        <div className="report-page">
          <div className="single-report-page">
            <div>
              <div className="report-title-text">
                <img className="report-title-photo" src={D3}></img>
                <div className="results-title-title" id="health">
                  Your Health Report
                </div>
                <div className="menuItem-report"></div>
              </div>
            </div>
            <div className="report-description">
              <div className="results-title-subtitle">
                Discover what your DNA told us about you
              </div>
            </div>
            <div className="results-main-bottom">
              <Link
                to="menuTitleNutrition"
                spy={true}
                smooth={true}
                offset={-100}
              >
                <button className="results-button-1">
                  <Typography variant="p" color="white" sx={{ mr: 2 }} noWrap>
                    <div className="results-button-title">
                      <span>Nutrition Requirement</span>
                    </div>
                  </Typography>
                </button>
              </Link>
              ...
              <Link
                to="menuTitleTraining"
                spy={true}
                smooth={true}
                offset={-100}
              >
                <button className="results-button-2">
                  <Typography variant="p" color="white" sx={{ mr: 2 }} noWrap>
                    <div className="results-button-title">
                      <span>Training Predisposition</span>
                    </div>
                  </Typography>
                </button>
              </Link>
            </div>
            <Link to="introhead" spy={true} smooth={true} offset={-130}>
              <button className="results-button-3">
                <Typography variant="p" color="white" sx={{ mr: 2 }} noWrap>
                  <div className="results-button-3-title">
                    <span>Sacha's personalised supplement overview</span>
                  </div>
                </Typography>
              </button>
            </Link>
            ...
            <div className="introhead">
              <h2 className="introTitle">Introduction</h2>
              <div className="intro">
                Lorem ipsum dolor sit amet. 33 illo quia id saepe molestiae est
                nobis aperiam eum cupiditate officia et tempora quia. Nam iste
                ipsa eos minus error et quia exercitationem ex consequuntur
                placeat qui voluptate sapiente ab quae sunt. In tempora internos
                et iure fugiat sit voluptate voluptatibus. At ullam velit ut
                fugiat ullam sit iusto voluptas et commodi reprehenderit ut
                magni doloribus vel voluptatem odio. Aut dignissimos velit et
                nobis vero sed fugiat praesentium est quisquam maiores vel
                dolorem maxime id tenetur alias aut quos ipsa. Non voluptatem
                quam ut nostrum quidem non sint qui ullam voluptatem. In dolore
                possimus et libero voluptas est neque velit et nemo tempore aut
                iusto veritatis ut numquam sequi. Et ratione nisi aut eveniet
                quos ad minus voluptate. Lorem ipsum dolor sit amet. 33 illo
                quia id saepe molestiae est nobis aperiam eum cupiditate officia
                et tempora quia. Nam iste ipsa eos minus error et quia
                exercitationem ex consequuntur placeat qui voluptate sapiente ab
                quae sunt. In tempora internos et iure fugiat sit voluptate
                voluptatibus. At ullam velit ut fugiat ullam sit iusto voluptas
                et commodi reprehenderit ut magni doloribus vel voluptatem odio.
                Aut dignissimos velit et nobis vero sed fugiat praesentium est
                quisquam maiores vel dolorem maxime id tenetur alias aut quos
                ipsa. Non voluptatem quam ut nostrum quidem non sint qui ullam
                voluptatem. In dolore possimus et libero voluptas est neque
                velit et nemo tempore aut iusto veritatis ut numquam sequi. Et
                ratione nisi aut eveniet quos ad minus voluptate.
              </div>
            </div>
          </div>

          {/* <div className="report-outcome-title">
              <div className="report-outcome-title-text">
                <span>{report.actionQuestion}</span>
              </div>
            </div>
            <div className="report-outcome-text">
              <span>{report.outcomeText}</span>
            </div> */}
        </div>
        <div className="report-donut-chart">
          <DonutChart className="TRR" />
        </div>
        <br /> <br /> <br /> <br />
        <br /> <br /> <br /> <br />
        <br /> <br /> <br /> <br />
            ...
            <div className="report-page">
              <div className="single-report-page">
                <div>
                  <div className="report-title-text">
                    <img className="report-title-photo" src={D3}></img>
                    <h3 className={report.name}>Your {report.name}</h3>
                    <div className="menuItem-report">
                      <div className="donut-card-report">
                        {" "}
                        <CircularDeterminate
                          value={"30"}
                          className="donut-chart-report"
                        ></CircularDeterminate>
                        <span className="level-report">Low</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="report-table">
                  <table>
                    ...
                    <tbody>
                      {report.snps.map((table, index) => {
                        return (
                          <tr key={[index]}>
                            <td className="table-c1">{table.title}</td>
                            <td>{table.overview}</td>
                            <td>{table.rs_id}</td>
                            <td>{table.genotype}</td>
                          </tr>
                        );
                      })}
                    </tbody>
                  ...
                  <div>
                    <div className="report-meaning">{report.meaning}</div>
                  </div>
                </div>
              </div>
        ...
        <br /> <br /> <br /> <br />
        <br /> <br /> <br /> <br />
        {TrainingSummaryArray.map((report) => {
          return (
            <div className="report-page">
              <div className="single-report-page">
                <div>
